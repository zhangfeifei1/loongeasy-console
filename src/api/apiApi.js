 ...
 * @param isAuth
 */
export const addApi = ({ apiCode, apiName, apiCategory, serviceId, path, status, priority, apiDesc, isAuth, isOpen, isEncrypt, isAra }) => {
  const data = {
    apiCode: apiCode,
    apiName: apiName,
 ...
 * @param isAuth
 */
export const updateApi = ({ apiId, apiCode, apiName, apiCategory, serviceId, path, status, priority, apiDesc, isAuth, isOpen, isEncrypt, isAra }) => {
  const data = {
    apiId: apiId,
    apiCode: apiCode,
    apiName: apiName,
