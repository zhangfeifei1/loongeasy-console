 ...
 * @param userType
 */
export const addApp = ({ appName, appNameEn, appType, appIcon, appOs, appDesc, status, website, developerId, appSymmetricEncryptionType, appAsymmetricEncryptionType }) => {
  const data = {
    appName: appName,
    appNameEn: appNameEn,
    appType: appType,
 ...
 * @param userType
 */
export const updateApp = ({ appId, appName, appNameEn, appType, appIcon, appOs, appDesc, status, website, developerId, appSymmetricEncryptionType, appAsymmetricEncryptionType }) => {
  const data = {
    appId: appId,
    appName: appName,
    appNameEn: appNameEn,
 ...
 */
export const updateAppClientInfo = ({ appId, grantTypes, redirectUrls, scopes, accessTokenValidity, refreshTokenValidity, autoApproveScopes, userInfoUrl, authorityResourceUrl }) => {
  const data = {
    appId: appId,
