<template>
  <div class="app-container wrapper">
    <el-tabs v-model="activeName" @tab-click="handleTabClick">
      <!-- 离线包管理 -->
      <el-tab-pane label="离线包管理" name="first">
            ...
            <el-table :data="tableData" style="width: 100%" :header-cell-style="{background:'#eef1f6',color:'#606266'}" :row-key="getRowKeys" :expand-row-keys="expands" @row-click="rowClick" @expand-change="expandChange">
              ...
              <el-table-column label="操作" min-width="240px">
                <template slot-scope="props">
                  ...
                  <el-link type="primary" :underline="false" style="margin-left:10px" @click="handleConfigurationFileDownload(props.row.packageUrl)">下载AMR文件</el-link>
                  <el-link type="primary" :underline="false" @click="handleConfigurationFileDownload(props.row.profileUrl)">下载配置文件</el-link>
                </template>
              </el-table-column>
            </el-table>
          </el-main>
...
<script>
import { addNewPackage, getPackageList, deletePackage, getConfiguration, updateConfiguration, getHistoryPackage, releasePackage, releasePackageHistory, releasePackageStop, releasePackageRecovery, releasePackageEnd } from '@/api/offlinePackageMgt'
...
export default {
  ...
  methods: {
    ...
    handleConfigurationFileDownload(url) { // 下载AMR文件、配置文件
      debugger
      const downloadElement = document.createElement('a')
      downloadElement.href = '/pmobile/diffpackage/zipdiffversion/package/download/' + url
